                    ...
                    <div class="card-body">
                        <form action="{{ route('aboutsus.update', $aboutsus->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>text (uz)</label>
                                    <input class="form-control @error('text_uz') is-invalid @enderror"value="{{ $aboutsus->title_uz }}"
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <label>text (ru)</label>
                                    <input class="form-control @error('text_ru') is-invalid @enderror"value="{{ $aboutsus->title_ru }}"
